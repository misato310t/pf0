...
<div class="sp-header">
  <a href="<?php echo esc_url( home_url('/') ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/logo-sp.png" alt=""></a>
   ...
   <h1 class="works-section-ttl single-page-works-ttl">作品一覧</h1>
        ...
        <div class="works-list-wrapper">
            <ul class="works-list-item">
                ...
                <li class="works-list-item-li">
                  ...
                  <h2 class="works-list-item-ttl">架空コーポレートサイト制作</h2>
                  <div class="works-goods"><img src="<?php echo get_template_directory_uri(); ?>/img/works-goods-min.png" alt=""></div>  
                  <p>オンライン学習サービスでの課題として制作しました。</p>
                ...
                <li class="works-list-item-li">
                  ...
                  <h2 class="works-list-item-ttl">架空コーポレートサイト制作</h2>
                  <div class="works-goods"><img src="<?php echo get_template_directory_uri(); ?>/img/works-goods-min.png" alt=""></div>  
                  <p class="works-list-img3">コーディング教材を配布されているWEBサイトの中のコーディング課題
                    です</p>
                ...
                <li class="works-list-item-li">
                  ...
                  <h2 class="works-list-item-ttl">架空カフェサイト制作</h2>
                  <div class="works-goods"><img src="<?php echo get_template_directory_uri(); ?>/img/works-goods-min.png" alt=""></div>  
                  <p class="works-list-img4">デザイン、コーディング、
                    ワードプレスの構築を行いました</p>
                ...
                <li class="works-list-item-li">
                  ...
                  <h2 class="works-list-item-ttl">架空訪問看護st.サイト制作</h2>
                  <div class="works-goods"><img src="<?php echo get_template_directory_uri(); ?>/img/works-goods-min.png" alt=""></div>  
                  <p class="works-list-img5">デザイン、コーディング、
                    ワードプレスの構築を行いました</p>
